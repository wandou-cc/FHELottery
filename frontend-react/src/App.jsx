...
function App() {
  const { account, connectWallet, disconnectWallet, balance, isPending, getSigner } = useWallet();
    ...
    <div className="min-h-screen relative">
      ...
      <main className="relative z-10 container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-8 animate-fadeIn">
          ...
          <button
            className="inline-flex items-center gap-2 px-5 py-2 btn-black"
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-black/80 leading-relaxed">
                            Your lottery numbers are encrypted using Fully Homomorphic Encryption (FHE). Nobody can see
                            your numbers — not even the contract. Winning numbers are drawn and verified entirely in the
                            encrypted space, ensuring fairness and privacy.
                          </p>
                        </div>
                      </div>
                    </CardBody>
                      ...
                      <CardBody className="p-6 text-center">
                        <div className="flex flex-col items-center gap-4">
                          ...
                          <div>
                            ...
                            <button className="btn-black px-6 py-2" onClick={connectWallet}>
                              Connect Wallet
                            </button>
                          </div>
                        </div>
